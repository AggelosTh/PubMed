...
x_train = sbert.encode(
    [sentence for sentence in X_train_text], device=device
)
x_dev = sbert.encode(
    [sentence for sentence in X_dev_text], device=device
)
x_test = sbert.encode(
    [sentence for sentence in X_test_text], device=device
)
